...
colors = {'single': 'C0',
          ...
          'gem': 'C4'}
"""
models = ['icarl', 'gem', 'single', 'GSS_Clust', 'FSS_Clust', 'rehearse_per_batch_rand', 'GSS_Greedy', 'GSS_IQP_Rehearse']
datasets = ['mnist_split']

names_datasets = {'mnist_split': 'MNIST split'}

names_models = {'icarl': 'iCaRL',
                'gem': 'GEM',
                'single': 'Single',
                'GSS_Clust': 'GSS_Clust',
                'FSS_Clust': 'FSS_Clust',
                'rehearse_per_batch_rand': 'Rand',
                'GSS_Greedy': 'GSS_Greedy',
                'GSS_IQP_Rehearse': 'GSS_IQP'}
